...
Rails.application.routes.draw do
  ...
  get '/admin_chat/:bot_id/messages', to: 'admin_chat#messages', as: 'admin_chat_messages'
  post '/admin_chat/:bot_id/message', to: 'admin_chat#send_message', as: 'admin_chat_send_message'
